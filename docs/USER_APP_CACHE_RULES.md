...
| Activity | Running `Microsoft Teams classic.app` or `Microsoft Teams.app`, or unavailable process census, blocks selection and execution; state is checked again at approval and immediately before the move |
...
Classic Teams and unknown process state, and negative Application Support,
group, preference and Keychain paths. Existing native
